data:extend(
{

	{
		type = "recipe",
		name = "y-infused-uca2",		
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/infused_uca2.png",
	...
	},	
	{
		type = "recipe",
		name = "y-infused-mud",		
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/fuel_cell_d.png",
	...
	-- toolhead-crushs
	{
		...
		name = "y-crush-blue_whead",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/dust_blue_whead.png",
		category = "y-crushing",
		energy_required = 7,
		ingredients = {
	...
	},
	{
		...
		name = "y-crush-green_whead",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/dust_green_whead.png",
		category = "y-crushing",
		energy_required = 7,
		ingredients = {
	...
	-- smeltings
	{
		...
		name = "y-press-richdust", category = "yuoki-formpress",		
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/uni-komp-a2-icon.png",
	...
	--[[
	{
		...
		name = "y-smelt-richdust-recipe", category = "smelting",		
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/orange-stuff.png",
	...
	]]
	{
		...
		name = "y-smelt-crush-res1", category = "yuoki-formpress",		
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/n4pellets_icon.png",
	...
	},	
	{
		...
		name = "y-smelt-crush-res2", category = "yuoki-formpress",		
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/f7pellets_icon.png",
	...
	},	
	{
		type = "recipe",
		name = "y-fuel-reactor",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/reactor-fuel.png", enabled = true, energy_required = 10,
		ingredients ={
	...
	--[[
	{
		...
		name = "y-fuel-alien-recipe",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/fuel_cell_b.png", enabled = true, energy_required = 30,
	...
	]]
	{
		...
		enabled = true,				
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/pure-copper-n.png",
	...
	
	{
		...
		enabled = true,				
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/pure-iron-n.png",		
	...
	-- with tools	
	{
		...
		enabled = true,				
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/pure_copper_wt.png",
		group = "yuoki", subgroup = "y_line2", order="z-b-copper",		
	},	
	{
		type = "recipe",
		...
		enabled = true,				
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/pure_iron_wt.png",		
		group = "yuoki", subgroup = "y_line2", order="z-a-iron",		
	},	
