data:extend(
{
	
	{
		...
		subgroup = "y-fuel",		
		order = "coal-b",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/coal_brikett_32.png",    		
	},

	{
		...
		subgroup = "y-fuel",		
		order = "coal-s",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/coal_briketts.png",    
	...
	-- new-coal-things 215-0103
	{
		type = "recipe",
		name = "y-coaldust",
		enabled = true,	energy_required = 2, category = "y-crushing", group = "yuoki", subgroup = "y-fuel", order = "coal-s",  icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/coal-dust.png",    		
		ingredients ={
	...
	},
	{
		...
		enabled = true,	energy_required = 2, category = "yuoki-formpress", group = "yuoki", subgroup = "y-fuel", order = "coal-s",  icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/mix-fuel.png",    		
		ingredients ={
	...
	},
	{
		type = "recipe",
		name = "y-mixfuel-load",
		enabled = true,	energy_required = 2, category = "yuoki-formpress", group = "yuoki", subgroup = "y-fuel", order = "coal-s",  icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/mix-fuel-loaded.png",    		
		ingredients ={
...

	{
		...
		subgroup = "y-fuel",		
		order = "wooden",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/wood_brikett_32.png",    		
	},

	{
		...
		subgroup = "y-fuel",		
		order = "wooden",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/wood-pellets.png",    		
	},	
		
	{
		...
		enabled = true,				
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/c_mud_icon.png",
		group = "yuoki",
	...
	
	{
		...
		--result = "y-dry_mud",
		--result_count = 1,
		icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/dry_mud_icon.png",
		category = "yuoki-formpress",		
		group = "yuoki",
...

	{
		...
		--result = "y-mixed-fuel",
		--result_count = 1,
		icon_size = 32, icon = "__Yuoki_F2__/graphics/icons/mix-fuel.png",
		category = "yuoki-formpress",		
		group = "yuoki-energy",
	...
	
	{
		...
		results=
		{
		 ...
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/bg-dusts.png",
		category = "yuoki-formpress",		
		group = "yuoki",
