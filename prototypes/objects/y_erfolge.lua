data:extend(
{
	...
	-- items
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/lamps/yi_obelisk_3.5icon.png",		
		group = "yuoki-energy",
		subgroup = "y_erfolge",
	...
	-- items
	{
		type = "item",
		name = "yi_bug1",
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/lamps/statue_bug1_icon.png",		
		group = "yuoki-energy",
		subgroup = "y_erfolge",
	...
	-- items
	{
		type = "item",
		name = "yi_hny1",
		icon_size = 64, icon =  "__Yuoki__/graphics/gfx/hny1_icon.png",		
		group = "yuoki-energy",
		subgroup = "y_erfolge",
	...
	-- items
	{
		type = "item",
		name = "yi_hny2",
		icon_size = 64, icon =  "__Yuoki__/graphics/gfx/hny2_icon.png",		
		group = "yuoki-energy",
		subgroup = "y_erfolge",
