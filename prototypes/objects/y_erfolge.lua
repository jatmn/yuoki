data:extend(
{
	...
	-- items
	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/lamps/yi_obelisk_3.5icon.png",		
		group = "yuoki-energy",
		subgroup = "y_erfolge",
	...
	},
	{
		...
		picture_off =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/lamps/yi_obelisk_3.5off.png",
			priority = "high",
			width = 256,
		...
		picture_on =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/lamps/yi_obelisk_3.5on.png",
			priority = "high",
			width = 256,
			height = 256, scale = 0.5,			
			shift = {0.5, -0.75}
	...
	-- items
	{
		type = "item",
		name = "yi_bug1",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/lamps/statue_bug1_icon.png",		
		group = "yuoki-energy",
		subgroup = "y_erfolge",
	...
	
	{
		...
		picture_off =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/lamps/statue_bug1_off.png",
			priority = "high",
			width = 256,
			height = 256, scale = 0.5,			
			shift = {0.5, -0.75}
		...
		picture_on =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/lamps/statue_bug1_on.png",
			priority = "high",
			width = 256,
			height = 256, scale = 0.5,			
			shift = {0.5, -0.75}
	...
	-- items
	{
		type = "item",
		name = "yi_hny1",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/gfx/hny1_icon.png",		
		group = "yuoki-energy",
		subgroup = "y_erfolge",
	...
	},	
	{
		...
		pictures =
		{
			...
			{
				{
					filename = "__Yuoki (Factorio 2.0)__/graphics/gfx/hny1_sheet-0.png",								
					priority = "low",
					width = 160,
					height = 224,
	...
	-- items
	{
		type = "item",
		name = "yi_hny2",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/gfx/hny2_icon.png",		
		group = "yuoki-energy",
		subgroup = "y_erfolge",
	...
	},			
	{
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
			  {
				filename = "__Yuoki (Factorio 2.0)__/graphics/gfx/hny2_sheet-0.png",								
				scale = 0.5,
				animation_speed = 0.2,	
				priority = "low",
				width = 160,
