	turret_flame =
	{
		...
		{
			{	
				filename = "__Yuoki_F2__/graphics/entity/defense/turm_flamer_place.png",
				priority = "medium",
				width = 256,
				height = 256,
				direction_count = 8,
...
data:extend({	 			

		{
			type = "recipe",
			name = "y_turret_flame",
			 icon_size = 32, icon =  "__Yuoki_F2__/graphics/entity/defense/turm_flamer_icon.png",
			enabled = true,
			ingredients =
			{
				...
				{
					{
						...
						filename = "__Yuoki_F2__/graphics/entity/defense/turm_flame_sheet.png",
						priority = "medium",
						width = 256,
						height = 256,
						direction_count = 64,
					...
					--[[
					{
						filename = "__Yuoki_F2__/graphics/entity/defense/turm_flamer_layer.png",
						line_length = 1,
						width = 96,
						height = 96,
						frame_count = 1,
