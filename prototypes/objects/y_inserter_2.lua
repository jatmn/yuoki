data:extend(
{
...

	{
		type = "item",
		name = "y_inserter_diagonal",
		icon_size = 32, icon =  "__Yuoki_F2__/graphics/entity/inserters/ins_diagonal.png",		
		group = "yuoki",		
		subgroup = "y_line9",		
		order = "c7a",
	...
	
	{
		...
		hand_base_picture =
		{
			filename = "__Yuoki_F2__/graphics/entity/inserters/special_base_3.png",
			priority = "extra-high",
			width = 12,
			height = 34,
		},
		hand_closed_picture =
		{
			filename = "__Yuoki_F2__/graphics/entity/inserters/special_ihc_3.png",
			priority = "extra-high",
			width = 18,
			height = 41,
			shift = {-0.0625, 0},
...

	{
		type = "item",
		name = "y_inserter_evade_shortR",
		icon_size = 32, icon =  "__Yuoki_F2__/graphics/entity/inserters/ins_evade_right_icon.png",		
		group = "yuoki",		
		subgroup = "y_line9",		
		order = "c8a",
...

	{
		type = "item",
		name = "y_inserter_evade_shortL",
		icon_size = 32, icon =  "__Yuoki_F2__/graphics/entity/inserters/ins_evade_left_icon.png",		
		group = "yuoki",		
		subgroup = "y_line9",		
		order = "c8b",
