...
return
{
	...
	{
		filename = "__Yuoki (Factorio 2.0)__/sounds/plasma-2.ogg",
		volume = 0.85
	},
	--[[
	{
...
turret_plasma =
{
	filename = "__Yuoki (Factorio 2.0)__/graphics/entity/defense/turm_plasma_place.png",
	priority = "medium",
	width = 256,
	height = 256,
	direction_count = 8,
...
data:extend({	 			
...

	{
		type = "item",
		name = "y_turret_plasma",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/defense/turm_plasma_icon.png",		
		group = "yuoki",
		--subgroup = "y-storage",	
		subgroup = "y-defense",		
		order = "p1",
	...
	
	{
		...
		prepared_animation =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/defense/turm_plasma_sheet.png",
			priority = "medium",
			width = 256,
			height = 256,
			direction_count = 64,
