data:extend(
{
...

	{
		type = "item",
		name = "yi_mine_plasma",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/mine_plasma_icon.png",		
		damage_radius = 6,
		subgroup = "y-defense",
		order = "t10",
...

	{
		...
		picture_safe =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/icons/mine_plasma_off.png", 
			priority = "medium",
			width = 64, height = 64, scale = 0.5,
		},
		picture_set =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/icons/mine_plasma_on.png",
			priority = "medium",
			width = 64, height = 64, scale = 0.5,		
		},
		trigger_radius = 3.5,
	...
	
	{
		type = "item",
		name = "yi_mine_impact",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/mine_imp_icon.png",		
		damage_radius = 10,
		subgroup = "y-defense",
		order = "t9",
	...
	
	{
		...
		picture_safe =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/icons/mine_imp_off.png",
			priority = "medium",
			width = 64, height = 64, scale = 0.5,
		},
		picture_set =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/icons/mine_imp_on.png",
			priority = "medium",
			width = 64, height = 64, scale = 0.5,
		},
		trigger_radius = 3.5,
