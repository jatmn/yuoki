data:extend(
{
	...
	-- items
	{
		...
		icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/modul_blue_1.png",		
		subgroup = "y-module",
		order = "m-1a",
		stack_size = 100,		
	...
	-- recipes
	{
		...
		name = "y-speed-module-2",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/modul_blue_2.png",
		energy_required = 2.0, enabled = true,
		ingredients = {
	...
	},		
	{
		...
		icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/modul_green_1.png",		
		subgroup = "y-module",
		order = "m-1b",
		stack_size = 100,
		default_request_amount = 10,
	...
	-- green-2
	{
		...
		icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/modul_green_2.png",
		energy_required = 2.0, enabled = true,
		ingredients = {
			{type="item", name="y-chip-2", amount=2},
	...
	-- green-op ultimate
	{
		...
		name = "y_modul_green_op",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/op_green_module.png",
	...
	-- red-op1
	{
		...
		icon_size = 32, icon =   "__Yuoki_F2__/graphics/icons/modul_science_32.png",
	...
	-- red-op2
	{
		type = "recipe",
		name = "y_modul_red2",
		 icon_size = 32, icon =   "__Yuoki_F2__/graphics/icons/modul_techanic_32.png",
		energy_required = 5.0, enabled = true,
		ingredients = {
			{type="item", name="y-speed-module-2", amount=1},
			{type="item", name="y-green-module-2", amount=1},
	...
	
	{
		...
		icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/modul_pink_1.png",		
		subgroup = "y-module",
		order = "m-4a",
		stack_size = 100,
		default_request_amount = 20,
...

	{
		...
		name = "y-pink-module-2",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/modul_pink_2.png",
		energy_required = 3.0, enabled = true,
		ingredients = {
			{type="item", name="y-chip-2", amount=2},
	...
	
	{
		...
		icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/modul_pink_3.png",		
		subgroup = "y-module",
		order = "m-4c",
		stack_size = 100,
		default_request_amount = 20,
