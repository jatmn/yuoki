...
data:extend({
	...
	{ type="item-group", name="yuoki", icon_size=64, icon="__Yuoki_F2__/graphics/icons/yuoki-ind-icon.png", inventory_order="y", order="yi-a" },
	--YI-Energy, Lamps, Fuel
	{ type="item-group", name="yuoki-energy", icon_size=64, icon="__Yuoki_F2__/graphics/icons/yuoki-energy.png", inventory_order="y", order="yi-b" },
	--YI-Transmutation & Trade
	{ type="item-group", name="yuoki-atomics", icon_size=64, icon="__Yuoki_F2__/graphics/icons/yuoki-atomics-icon.png", inventory_order="y", order="yi-c" },
	--YI-Refinery & Fluids 
	{ type="item-group", name="yuoki_liquids", icon_size=64, icon="__Yuoki_F2__/graphics/icons/yuoki-liquids.png", inventory_order="y", order="yi-d" },
