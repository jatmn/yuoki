...
{  

	{
		...
		name = "yi_logistic-robot",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/rob_log_icon.png",
		...
		idle =
		{
			filename = "__Yuoki_F2__/graphics/entity/rob_log_sheet.png",
			priority = "high",
			line_length = 16,
			width = 40,
			height = 40,
...

	{
		...
		name = "yi_construction-robot",
		 icon_size = 32, icon =  "__Yuoki_F2__/graphics/icons/rob_con_icon.png",
		flags = {"placeable-player", "player-creation", "placeable-off-grid", "not-on-map"},
		...
		idle =
		{
			filename = "__Yuoki_F2__/graphics/entity/rob_con_sheet.png",
			priority = "high",
			line_length = 16,
			width = 40,
			height = 40,
