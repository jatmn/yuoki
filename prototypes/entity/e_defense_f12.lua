turret_gun1f12 = {
	filename = "__Yuoki_F2__/graphics/entity/defense/gun_1_place.png",
	priority = "medium",
	width = 128,
	height = 128,
	direction_count = 8,
...
turret_gun2f12 = {
	filename = "__Yuoki_F2__/graphics/entity/defense/gun2_place.png",
	priority = "medium",
	width = 128,
	height = 128,
	direction_count = 8,
...
turret_laser22f12 = {
	filename = "__Yuoki_F2__/graphics/entity/defense/laser22b_place.png",
	priority = "medium",
	width = 128,
	height = 128,
	direction_count = 8,
	...
	{
		{
			...
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/entity/defense/laser22b_icon.png",
			...
			prepared_animation = {
				filename = "__Yuoki_F2__/graphics/entity/defense/laser22b_sheet.png",
				priority = "medium",
				width = 128,
				height = 128,
				shift = {0.5, -0.72},
		...
		},
		{
			...
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/entity/defense/gun_1_icon.png",
			...
			prepared_animation = {
				filename = "__Yuoki_F2__/graphics/entity/defense/gun_1_sheet.png",
				priority = "medium",
				width = 128,
				height = 128,
				direction_count = 64,
		...
		},
		{
			...
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/entity/defense/gun2_icon.png",
			flags = {"placeable-player", "player-creation"},
			...
			prepared_animation = {
				filename = "__Yuoki_F2__/graphics/entity/defense/gun2_sheet.png",
				priority = "medium",
				width = 128,
				height = 128,
				direction_count = 64,
