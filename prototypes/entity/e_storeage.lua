...
{	
	{
		...
		picture =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/store/y-c11.png",
			priority = "high",
			width = 48,
			height = 48,
			shift = {0.1875, -0.094},
	...
	},
	{
		...
		picture =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/store/y-lc11.png",
			priority = "extra-high",
			width = 48,
			height = 48,
			shift = {0.1875, -0.094},
	...
	-- new 22
	{
		...
		picture =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/store/y-c22.png",
			priority = "high",
			width = 96,
			height = 96,
			shift = {0.5, -0.125},
	...
	-- new 3x3
	{
		...
		picture =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/store/y-cg33.png",
			priority = "high",
			width = 128,
			height = 128,
			shift = {0.5, -0.125},
		...
		
	{
		...
		picture =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/store/y-cl33.png",
			priority = "high",
			width = 128,
			height = 128,
			shift = {0.5, -0.125},
	...
	
	{
		...
		picture =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/store/y-c44.png",
			priority = "high",
			width = 160,
			height = 160,
			shift = {0.5, -0.25},
	...
	-- passive provider 2x2
	{
		...
		picture =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/store/y-pc22.png",
			priority = "extra-high",
			width = 96,
			height = 96,
			shift = {0.5, -0.125}
	...
	--	requester 2x2
	{
		...
		picture =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/store/y-rc22.png",
			priority = "extra-high",
			width = 96,
			height = 96,
			shift = {0.5, -0.125}
