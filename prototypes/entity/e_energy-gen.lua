	...
	{	
		{
			...
			name = "y-boiler-iv",
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/icons/boiler-3m-icon.png",
			...
			pictures = {
					north = {
						structure =
						{
							filename = "__Yuoki (Factorio 2.0)__/graphics/entity/big_boiler_r18.png",
							priority = "extra-high",
							width = 256,
							height = 256,
							shift = {0.375, -0.25},
		...
		-- big steam-turbine
		{
			...
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/entity/steam_turbine_n3_icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			horizontal_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/steam_turb_v3_sheet.png",
				width = 320,
				height = 320,
				frame_count = 10,
				line_length = 5,
			...
			vertical_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/steam_turb_h3_sheet.png",
				width = 320,
				height = 320,
				frame_count = 10,
				line_length = 5,
		...
		-- rensuir/obninsk-turbine
		{
			...
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/icons/rensuir-turbine_icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			horizontal_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/rens_ah.png",
				width = 120,
				height = 96,
				frame_count = 18,
				line_length = 9,
			...
			vertical_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/rens_av.png",
				width = 96,
				height = 128,
				frame_count = 18,
				line_length = 18,
			...
			pipes_horizontal = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/pipes_h96.png",
				priority = "high",
				width = 96,
				height = 44,
				shift = {0, 0}
			...
			pipes_vertical = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/pipes_v96.png",
				priority = "high",
				width = 44,
				height = 96
			}
		},
		{
			...
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/lt-v2p-icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			horizontal_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/ss800h_sheet.png",
				width = 256,
				height = 256,
				frame_count = 16,
				line_length = 4,
			...
			vertical_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/ss800v_sheet.png",
				width = 256,
				height = 256,
				frame_count = 16,
				line_length = 4,
		...
		-- small electric generator
		{
			...
			name = "y-seg",
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/seg-s_icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			horizontal_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/seg-ha-s2.png",
				width = 80,
				height = 90,
				frame_count = 18,
				line_length = 18,
			...
			vertical_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/seg-va-s.png",
				width = 112,
				height = 96,
				frame_count = 18,
				line_length = 18,
		...
		-- small electric generator - primary reduced continuance
		{
			...
			name = "y-seg-p",
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/seg-p_icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			horizontal_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/segn_we_sheet.png",
				width = 256,
				height = 256,
				frame_count = 4,
				line_length = 4,
			...
			vertical_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/segn_ns_sheet.png",
				width = 256,
				height = 256,
				frame_count = 4,
				line_length = 4,
		...
		-- medium second electric generator
		{
			...
			name = "y-meg-s",
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/meg-s-icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			horizontal_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/meg_219_ew_sheet.png",
				width = 192,
				height = 192,
				frame_count = 16,
				line_length = 4,
			...
			vertical_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/meg_219_ns_sheet.png",
				width = 192,
				height = 192,
				frame_count = 16,
				line_length = 4,
		...
		-- big electric generator
		{
			...
			name = "y-beg",
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/beg_icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			horizontal_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/beg-hac.png",
				width = 96,
				height = 160,
				frame_count = 18,
				line_length = 18,
			...
			vertical_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/beg-vac.png",
				width = 160,
				height = 120,
				frame_count = 18,
				line_length = 9,
		...
		-- huge electric generator
		{
			...
			name = "y-heg",
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/heg-icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			energy_source = {type = "electric", usage_priority = "secondary-output"},
			horizontal_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/heg-ha.png",
				width = 100,
				height = 224,
				frame_count = 18,
				line_length = 18,
			...
			vertical_animation = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/energy-t2/heg-va.png",
				width = 224,
				height = 146,
				frame_count = 18,
				line_length = 9,
		...
		-- stirling solar-dish
		{
			...
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/icons/stir-solar-dish-icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			picture = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/stir-solar-dish.png",
				priority = "high",
				width = 64,
				height = 64,
				shift = {0, 0}
		...
		-- Alien-Solar 1
		{
			...
			name = "y_alien_solar",
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/entity/yi_alien_solar_icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			picture = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/solar_1_r21.png",
				priority = "high",
				width = 320,
				height = 320,
				shift = {1.0, -0.75}
		...
		-- Alien-Solar 2
		{
			...
			name = "y_alien_solar2",
			icon_size = 32,
			icon = "__Yuoki (Factorio 2.0)__/graphics/entity/yi_alien_solar2_icon.png",
			flags = {"placeable-neutral", "player-creation"},
			...
			picture = {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/solar_2_r20.png",
				priority = "high",
				width = 384,
				height = 384,
				shift = {1, -0.75}
