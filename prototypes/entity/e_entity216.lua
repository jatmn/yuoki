...
data:extend({
	{
		...
		pictures =
		{
			filename = "__Yuoki_F2__/graphics/entity/radar_sheet.png",
			priority = "low",
			width = 160,
			height = 160,
	...
	
	{
		...
		base_picture =
		{
			filename = "__Yuoki_F2__/graphics/entity/beacon_anim0001.png",
			width = 160,
			height = 160,
			shift = { 0.6875, -0.75}
		},
		...
		animation =
		{
			filename = "__Yuoki_F2__/graphics/entity/beacon_sheet.png",
			width = 160,
			height = 160,
			line_length = 5,
			frame_count = 25,
		...
		animation_shadow =
		{		
			filename = "__Yuoki_F2__/graphics/entity/empty32.png",
			width = 5,
			height = 5,
			line_length = 5,
			frame_count = 25,
...

	{
		...
		base =
		{
			filename = "__Yuoki_F2__/graphics/entity/roboport_frame.png",
			width = 320,
			height = 320,
			scale = 0.5,
			shift = {0.5, -0.5}
		...
		base_animation =
		{
			filename = "__Yuoki_F2__/graphics/entity/roboport_sheet.png",
			priority = "medium",
			width = 320,
			height = 320,
			scale = 0.5,
		...
		door_animation_up =
		{
			filename = "__Yuoki_F2__/graphics/entity/empty25x25.png",
			priority = "medium",
			width = 5,
			height = 25,
			frame_count = 5,
