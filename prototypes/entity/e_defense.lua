y_weapon_ztt = {
	filename = "__Yuoki_F2__/graphics/entity/defense/zzt-place.png",
	priority = "medium",
	width = 160,
	height = 160,
	shift = {0.31, -0.75},
	--filename = "__Yuoki_F2__/graphics/entity/y_weapon-ztt-c.png",
...
y_laser2x2 = {
	filename = "__Yuoki_F2__/graphics/entity/defense/laser22f12-h-place.png",
	priority = "medium",
	width = 128,
	height = 128,
	direction_count = 8,
	...
	{
		{
			...
			name = "y-weapon-ztt",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/entity/defense/zzt-icon.png",
			...
			prepared_animation = {
				filename = "__Yuoki_F2__/graphics/entity/defense/zzt-sheet.png",
				priority = "medium",
				width = 160,
				height = 160,
				shift = {0.31, -0.75},
		...
		},
		{
			...
			name = "y-laser-def-s4",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/entity/defense/laser2x2_r16n-icon.png",
			flags = {"placeable-player", "placeable-enemy", "player-creation"},
			...
			prepared_animation = {
				filename = "__Yuoki_F2__/graphics/entity/defense/laser22f12-h-sheet.png",
				priority = "medium",
				width = 128,
				height = 128,
				shift = {0.1875, -0.625},
