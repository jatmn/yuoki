...
{  
	--[[
	{
		...
		name = "archsite",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/archsite_icon.png",
		...
		animation = {
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/archsite_n.png",
			priority = "medium",
			width = 170,
			height = 160,
			frame_count = 1,						
	...
	
	{
		...
		name = "y-underground-drill", minable = {mining_time = 0.5,result = "y-underground-drill"},
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/deep-drill-v1-icon.png",
		flags = {"placeable-neutral","player-creation"},		
		max_health = 200,
		resistances = {{type = "fire",percent = 70}},
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
			  {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/std_digger_sheet.png",
				priority = "medium",
				width = 256,
				height = 256,
				frame_count = 16,		
	...
	
	{
		type = "assembling-machine",
		name = "y-dirtwasher",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/dw.png",
		flags = {"placeable-neutral","player-creation"},
		...
		graphics_set =
		{
		  animation =
		  {
			north =
			{
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/washer-ns.png",
				priority = "medium", width = 128, height = 128, frame_count = 16, shift = {0.5, -0.25}, animation_speed=0.7,
			},
			east =
			{
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/washer-ew.png",
	...
	-- Outpost Mining Drill
	{
		type = "mining-drill",
		name = "y-mining-drill",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/mine-drill-o-icon.png",
		flags = {"placeable-neutral", "player-creation"},
			...
			{
			  {
				...
				shift = {1.0, -0.75},
				scale = 0.9,
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/miners/miner_b_sheet.png",
				frame_count = 36,
				animation_speed = 0.5,
			  },
			}
	...
	-- E2 Mining Drill
	{
		...
		name = "y-mining-drill-e2",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/mine-drill-g-icon.png",
		flags = {"placeable-neutral", "player-creation"},
			...
			{
			  {
				...
				line_length = 4,
				shift = {0, -0.25},
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/miners/e2miner_sheet.png",
				frame_count = 16,
				animation_speed = 0.5,
			  },
			}
	...
	
	{
		...
		name = "y-atomic-quantum-composer",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/space-assembly-icon.png",
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
			  {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/composer_sheet.png",
				priority = "high",
				width = 320,
				height = 320,
				frame_count = 25,
...

	{
		...
		name = "y-atomic-constructor",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/cimota-icon.png",
		flags = {"placeable-neutral","placeable-player", "player-creation"},
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
			  {
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/cimota_sheet.png",
			priority = "high",
			width = 256,
			height = 256,
			frame_count = 16,
	...
	
	{
		...
		name = "y-alien-infuser",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/alien_infuser_icon.png",
		flags = {"placeable-neutral","placeable-player", "player-creation"},
		...
		picture =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/alien_infuser_v2_idle.png",			
			width = 128,
			height = 128,
			shift = {0.5, -0.5}
		},
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
				{
					filename = "__Yuoki (Factorio 2.0)__/graphics/entity/infuser_sheet_v2.png",
					priority = "high",
					width = 256,
					height = 256,
					frame_count = 16,
	...
	-- water generator - solid fuel
	{
		type = "assembling-machine",
		name = "y-water-gen",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/alien_water_gen_icon.png",
		flags = {"placeable-neutral","placeable-player", "player-creation"},
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
			  {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/watergen_c_sheet.png",
				priority = "high",
				width = 256,
				height = 256,
				frame_count = 16,
	...
	-- water generator - electric fuel
	{
		type = "assembling-machine",
		name = "y-water-gen-e",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/alien_water_gen-e-icon.png",
		flags = {"placeable-neutral","placeable-player", "player-creation"},
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
			  {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/watergen_e_sheet.png",
				priority = "high",
				width = 256,
				height = 256,
				frame_count = 16,
	...
	-- water mixer - electric fuel
	{
		type = "assembling-machine",
		name = "y_water_mixer",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/water_mixer_icon.png",
		flags = {"placeable-neutral","placeable-player", "player-creation"},
		...
		animation =
		{
			filename = "__Yuoki (Factorio 2.0)__/graphics/entity/water_mixer_sheet.png",
			priority = "high",
			width = 256,
			height = 256,
			frame_count = 16,
...

	{
		...
		name = "y-heat-form-press",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/pressure_icon.png",
		flags = {"placeable-neutral","player-creation"},
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
			  {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/formpress_anim.png",
				priority = "medium",
				width = 64,
				height = 72,
				frame_count = 9,						
	...
	
	{
		type = "assembling-machine",
		name = "y-crusher",
		 icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/crusher-icon.png",
		flags = {"placeable-neutral","placeable-player", "player-creation"},
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
			  {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/crusher-anim.png",
				priority = "medium",
				width = 65,
				height = 78,
				frame_count = 11,
