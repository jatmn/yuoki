data:extend(
{

	{
		...
		main_product = "y-res1",
		icon = "__Yuoki (Factorio 2.0)__/graphics/icons/uni-com-pur.png",
		icon_size = 32,  
...

	{
		...
		main_product = "y-res2",
		icon = "__Yuoki (Factorio 2.0)__/graphics/icons/yi-res-2-pur.png",
		icon_size = 32,  
...

	{
		...
		name = "y_trockner",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/base_factory_icon.png",
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
			  {
				filename = "__Yuoki (Factorio 2.0)__/graphics/entity/base_factory_sheet.png",
...

	{
		type = "assembling-machine",
		name = "y_crystalizer",
		icon_size = 64, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/crys_icon.png",
		flags = {"placeable-neutral","player-creation"},
		...
		graphics_set =
		{
		  animation =
		  {
			...
			{
				{
					filename = "__Yuoki (Factorio 2.0)__/graphics/entity/crys.png",
...

	{
		type = "assembling-machine",
		name = "y_hppump",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/hppump_icon.png",
		flags = {"placeable-neutral","player-creation"},
		...
		graphics_set =
		{
		  animation =
		  {
			north =
			{
				...
				{
			  		{
						filename = "__Yuoki (Factorio 2.0)__/graphics/entity/hppump_n.png",
			...
			east =
			{
				...
				{
			  		{
						filename = "__Yuoki (Factorio 2.0)__/graphics/entity/hppump_e.png",
						priority = "medium", width = 320, height = 320, frame_count = 1, shift = {0, 0}, scale=0.5, animation_speed=0.5,	
			 		},
				}
			},
			south =
			{
				...
				{
			  		{
						filename = "__Yuoki (Factorio 2.0)__/graphics/entity/hppump_s.png",
						priority = "medium", width = 320, height = 320, frame_count = 1, shift = {0, 0}, scale=0.5, animation_speed=0.5,	
			 		},
				}
			},
			west =
			{
				...
				{
			  		{
						filename = "__Yuoki (Factorio 2.0)__/graphics/entity/hppump_w.png",
						priority = "medium", width = 320, height = 320, frame_count = 1, shift = {0, 0}, scale=0.5, animation_speed=0.5,	
			 		},
				}
			},
	...
	},	
	{
		...
		icon_size = 64, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/store/mftank_ico.png",
	...
	},	
	{
		...
		pictures={
			...
			{
				sheet={
					filename = "__Yuoki (Factorio 2.0)__/graphics/entity/store/mftank.png",
					priority = "high",
					frames = 1,
					width = 320,
					height = 320,
