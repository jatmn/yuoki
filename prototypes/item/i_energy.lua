...
{
	{
		type = "item",
		name = "y-boiler-iv",
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/boiler-3m-icon.png",		
		group="yuoki-energy", 
		subgroup = "y-boiler",
	...
	},	
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/obninsk-reactor-icon.png",		
		group="yuoki-energy", 
		subgroup = "y-boiler",
	...
	},
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/rensuir-turbine_icon.png",		
	...
	},		
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/steam_turbine_n3_icon.png",		
	...
	},
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/energy-t2/lt-v2p-icon.png",		
	...
	-- small electric generator
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/energy-t2/seg-s_icon.png",		
	...
	-- small electric generator
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/energy-t2/seg-p_icon.png",		
	...
	-- medium-s electric generator
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/energy-t2/meg-s-icon.png",		
	...
	-- big electric generator
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/energy-t2/beg_icon.png",		
	...
	-- huge electric generator
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/energy-t2/heg-icon.png",		
