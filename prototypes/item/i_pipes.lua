data:extend(
{
	...
	},
	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/pipe-hc.png", order = "pipe-hc", subgroup = "y-pipe",
		stack_size = 150, default_request_amount = 50,
	},
	{
		type = "item",
		name = "y-pipe-to-ground-hc", place_result = "y-pipe-to-ground-hc",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/pipe-tg-hc.png", order = "pipe-hc", subgroup = "y-pipe",
		stack_size = 150, default_request_amount = 50,
	},	
	{
		type = "item",
		name = "y-pipe-ec", place_result = "y-pipe-ec",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/pipe-ec.png", order = "pipe-ec", subgroup = "y-pipe",
		stack_size = 150, default_request_amount = 50,
	},
	{
		type = "item",
		name = "y-pipe-to-ground-ec", place_result = "y-pipe-to-ground-ec",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/pipe-tg-ec.png",	order = "pipe-ec", subgroup = "y-pipe",
		stack_size = 150, default_request_amount = 50,
	},
	-- grüne Pipes - 26.4.2022
	{
		...
		icon_size = 64, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/g_pipe_icon.png", order = "pipe-green", subgroup = "y-pipe",
		stack_size = 100, default_request_amount = 50,
	},
	{
		type = "item",
		name = "yi_pipe_underground_green", place_result = "yi_pipe_underground_green",
		icon_size = 64, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/g_pipe_u_icon.png",	order = "pipe-green-u", subgroup = "y-pipe",
		stack_size = 100, default_request_amount = 50,
	},
