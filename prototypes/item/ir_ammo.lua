data:extend(
	{
		...
		},
		{
			...
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/capsule_plasma.png",
			enabled = true,
			energy_required = 4,
			ingredients = {
		...
		-- ammo
		{
			...
			name = "y-bullet-case",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/shell-case.png",
			group = "yuoki",
			subgroup = "y-ammo",
			order = "a1",
			stack_size = 250,
		...
		},
		{
			...
			name = "y_ammo_case",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/ammo_capsel.png",
			group = "yuoki",
			subgroup = "y-ammo",
			order = "a2",
			stack_size = 250,
		...
		},
		{
			...
			name = "y-ammo-acid-2",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/ammo_poison.png",
		...
		},
		{
			...
			name = "y-ammo-hohlspitz",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/ammo_fire.png",
			ammo_category = "bullet",
			ammo_type = {
				--category = "bullet",
				action = {
		...
		},
		{
			...
			name = "y-ammo-explosiv",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/ammo_wot.png",
			ammo_category = "bullet",
			ammo_type = {
				--category = "bullet",
				action = {
		...
		},
		{
			...
			name = "y-ammo-poison",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/ammo_silver.png",
			ammo_category = "bullet",
			ammo_type = {
				--category = "bullet",
				action = {
		...
		},
		{
			...
			name = "y-ammo-biggun",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/ammo_std.png",
			ammo_category = "bullet",
			ammo_type = {
				--category = "bullet",
				action = {
		...
		},
		{
			...
			name = "y-ammo-krakon",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/ammo_wolfram.png",
			ammo_category = "bullet",
			ammo_type = {
				--category = "bullet",
				action = {
		...
		},
		{
			...
			name = "y_ammo_flame",
			icon_size = 32,
			icon = "__Yuoki_F2__/graphics/icons/capsule_fire.png",
		...
		},
		{
			...
			icon = "__Yuoki_F2__/graphics/icons/c_shell_icon.png",
			icon_size = 64,
		...
		},
		{
			...
			icon = "__Yuoki_F2__/graphics/icons/a_shell_icon.png",
			icon_size = 64,
