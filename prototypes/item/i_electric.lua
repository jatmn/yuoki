...
{	
	{
		type = "item",
		name = "y_chip_plate",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/chip_plate.png",		
		--group = "yuoki",		
		subgroup = "y_parts_e",
		order = "a-0",		
	...
	},
	{
		type = "item",
		name = "y_dotzetron",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/dot_zetron_32.png",		
		--group = "yuoki",		
		subgroup = "y-parts",
		order = "a-0",		
		stack_size = 250, default_request_amount = 50,
	},
	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/gfx/battery_2.png",		
		subgroup = "y-electric",
		order = "a-1",				
		stack_size = 250, default_request_amount = 50,
	},	
	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/gfx/battery_1.png",		
		subgroup = "y-electric",
		order = "a-2",		
	...
	},	
	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/gfx/battery_3.png",		
		--group = "yuoki",		
		subgroup = "y-electric",
		order = "a-3",		
		fuel_category = "chemical", 
...

	{
		type = "item",
		name = "y_blocked_capa",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/gfx/scd-icon.png",		
		--group = "yuoki",		
		subgroup = "y-electric",
		order = "a-4",				
		stack_size = 250, default_request_amount = 50,
