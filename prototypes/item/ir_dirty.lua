data:extend(
{
	...
	},	
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/drillhead_repair.png", order="1A",
	},	
	{
		type = "item",
		name = "y_drillhead",
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/icon-5e.png",		
	...
	},
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/icon-5c.png",
		stack_size = 50, default_request_amount = 10,
		group = "yuoki", subgroup = "yuoki-formpress",					
	},
	...
	},	
	{
		...
		main_product = "y_toolhead",						
		subgroup = "yuoki-formpress", category = "yuoki-repair",		
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/toolhead_repair.png", order="1B",
	},	
	{
		type = "item",
		name = "y_toolhead",
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/toolhead.png",
	...
	},
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/toolhead_broken.png",
		stack_size = 75, default_request_amount = 10,
		group = "yuoki", subgroup = "yuoki-formpress",					
	},
...

	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/dirt_whead.png", order="dfd2",
	},	
