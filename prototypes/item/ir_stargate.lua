data:extend(
{
	...
	-- fame trade for fuel-cell
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/fuel_cell_c.png",
	},		
	
	-- fuel-cell-c	
	{ type = "item", name = "y-fuel-cell-c",  icon_size = 64, icon =  "__Yuoki__/graphics/icons/fuel_cell_c.png",  subgroup = "y-fuel", fuel_category = "chemical", fuel_value = "10GJ", stack_size = 500, default_request_amount = 10,},	
	-- fame recipe
	{
		type = "recipe",
		name = "y-fame",
	...
	{ 
		...
		subgroup = "y-stargate-4", category = "yuoki-fame",},	
	-- fame	
	{ type = "item", name = "y-fame",  icon_size = 64, icon =  "__Yuoki__/graphics/icons/fame-icon.png", subgroup = "y-stargate-f", stack_size = 10000, default_request_amount = 10,},
	...
	-- stargate itself
	{ type = "item", name = "y-stargate", place_result = "y-stargate",  icon_size = 64, icon =  "__Yuoki__/graphics/icons/laika-gate-icon.png", group = "yuoki-energy", subgroup = "y_ultimate_products", stack_size = 3,},			
	...
	-- 40-Users
	{ type = "item", name = "y-fame-gen", place_result = "y-fame-gen",  icon_size = 64, icon =  "__Yuoki__/graphics/entity/thanks-icon.png", group = "yuoki-energy", subgroup = "y_ultimate_products", stack_size = 6,},			
