data:extend(
{

	{
		...
		max_temperature = 150,
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/h2o_c2_icon.png",
...

	{
		...
		max_temperature = 250,
		-- icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/gfx/water-clean1.png",
	...
	--mechanical force
	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/mf-1.png", 
