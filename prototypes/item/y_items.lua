...
{	
	...
	{ 
		type = "item", name = "y-mixed-fuel-loaded",  icon_size = 32, icon =  "__Yuoki__/graphics/icons/mix-fuel-loaded.png", group = "yuoki", subgroup = "y-fuel",
		fuel_category = "chemical", fuel_value = "40MJ", stack_size = 250, default_request_amount = 50,
	},	
	{
		type = "item", name = "y-wooden-brikett",  icon_size = 32, icon =  "__Yuoki__/graphics/icons/wood_brikett_32.png", group = "yuoki", subgroup = "y-fuel", 
		fuel_category = "chemical", fuel_value = "10MJ", stack_size = 250, default_request_amount = 50,
	},
	{
		type = "item", name = "y-wooden-brikett-packed",  icon_size = 32, icon =  "__Yuoki__/graphics/icons/wood-pellets.png", group = "yuoki", subgroup = "y-fuel", 
		fuel_category = "chemical", fuel_value = "40MJ", stack_size = 250, default_request_amount = 50,
	},
	
	{
		type = "item",
		name = "y-crystal2",
		icon_size = 32, icon =  "__Yuoki__/graphics/icons/crystal_2.png",
		group = "yuoki",
...

	{
		type = "item",
		name = "y-toxic-dust",
		icon_size = 32, icon =  "__Yuoki__/graphics/icons/toxic-dust_icon.png",
		group = "yuoki",
		subgroup = "yuoki-formpress",		
