...
{	
...

	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/icons/rareore-wall-icon.png",		
		group = "yuoki",		
	...
	
	{
		type = "item",
		name = "y-laser-def-s4",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/defense/laser2x2_r16n-icon.png",		
		subgroup = "y-defense",
	...
	
	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/defense/gun_1_icon.png",		
		subgroup = "y-defense",
		order = "b[turret]-c[gun-turret]",
	...
	},	
	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/defense/gun2_icon.png",		
		subgroup = "y-defense",
		order = "b[turret]-c[gun-turret]",
	...
	
	{
		...
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/defense/laser22b_icon.png",		
		subgroup = "y-defense",
		order = "b[turret]-c[gun-turret]",
	...
	-- y_weapon-ztt
	{
		type = "item",
		name = "y-weapon-ztt",
		icon_size = 32, icon =  "__Yuoki (Factorio 2.0)__/graphics/entity/defense/zzt-icon.png",		
		subgroup = "y-defense",
		order = "b[turret]-c[gun-turret]",
