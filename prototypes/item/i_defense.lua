...
{	
	{
		type = "item",
		name = "y-mud-wall",
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/m_wall_icon.png",		
		group = "yuoki",
...

	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/rareore-wall-icon.png",		
		group = "yuoki",		
	...
	},
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/rare2-wall-icon2.png",		
		group = "yuoki",		
	...
	},
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/icons/wall-forcefield-icon.png",		
		group = "yuoki",		
		order = "a[wall]-a[wall]-c",
		subgroup = "y_defense_walls",
	...
	
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/walls/wall_hardic_icon.png",				
		group = "yuoki",		
		subgroup = "y_defense_walls",
		order = "a[wall]-a[wall]-c",		
	...
	
	{
		type = "item",
		name = "y-laser-def-s4",
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/defense/laser2x2_r16n-icon.png",		
		subgroup = "y-defense",
	...
	
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/defense/gun_1_icon.png",		
		subgroup = "y-defense",
		order = "b[turret]-c[gun-turret]",
	...
	},	
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/defense/gun2_icon.png",		
		subgroup = "y-defense",
		order = "b[turret]-c[gun-turret]",
	...
	
	{
		...
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/defense/laser22b_icon.png",		
		subgroup = "y-defense",
		order = "b[turret]-c[gun-turret]",
	...
	-- y_weapon-ztt
	{
		type = "item",
		name = "y-weapon-ztt",
		icon_size = 64, icon =  "__Yuoki__/graphics/entity/defense/zzt-icon.png",		
		subgroup = "y-defense",
		order = "b[turret]-c[gun-turret]",
